...
public final class ClassUtil {
    ...
    public static long toTimestamp(Object obj, long defaultValue) {
        return toTimestamp(obj, "yyyy-MM-dd HH:mm:ss", defaultValue);
    }
    ...
    public static long toTimestamp(Object obj, String pattern, long defaultValue) {
        if (obj instanceof Long) {
            ...
            try {
                DateTimeFormatter formatter = DatePatternMap.get(pattern);
                if (formatter == null) {
                    formatter = DateTimeFormat.forPattern(pattern);
                    DatePatternMap.put(pattern, formatter);
                }
                return formatter.parseMillis(str);
            } catch (Exception e) {
                log.error("time str is {}, pattern is {}", str, pattern, e);
                e.printStackTrace();
                return defaultValue;
            }
        }
