...
public class SqlserverInputFormat extends JdbcInputFormat {
	private static final long serialVersionUID = -7282500061785246521L;
			...
			for (int pos = 0; pos < row.getArity(); pos++) {
				...
				if (obj != null) {
					if (CollectionUtils.isNotEmpty(descColumnTypeList)) {
						...
						} else if ("datetimeoffset".equalsIgnoreCase(columnType)) {
							obj = resultSet.getString(pos + 1);
						}
					}
	...
	@Override
	protected List<String> analyzeTable(String dbUrl, String username, String password,
			DatabaseInterface databaseInterface, String table, List<MetaColumn> metaColumns) {
